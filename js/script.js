...
(() => {
  ...
  document.getElementById('shareBtn').addEventListener('click', () => {
    ...
    const html = '<!DOCTYPE html>' +
      ...
      'new Chart(ctxD,{type:"bar",data:{labels:["정독","추천","습관","어휘","표현","서술","배경","중심내용","중심생각","발언"],' +
      'datasets:[{label:"내 평점",data:my,backgroundColor:"rgba(54,162,235,0.5)"},' +
      '{label:"전체평균",data:avg,backgroundColor:"rgba(255,159,64,0.5)"}]},options:{scales:{y:{beginAtZero:true,suggestedMax:5}}}});' +
      'const ctxM=document.getElementById("monthCvs").getContext("2d");' +
